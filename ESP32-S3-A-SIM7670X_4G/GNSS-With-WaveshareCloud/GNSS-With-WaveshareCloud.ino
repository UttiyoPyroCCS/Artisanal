...
#define STASSID "Maxwadrin"
#define STAPSK "101202522"

#define MAX17048_I2C_ADDRESS 0x36
const char *clientID = "20c4ee8c"; // Client ID
char sub[] = "Pub/446/37/20c4ee8c"; // Sub Topic
char pub[] = "Sub/446/37/20c4ee8c"; // Pub Topic
